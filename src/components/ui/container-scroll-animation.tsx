...
// 21st.dev / Aceternity — Container Scroll Animation (perspective card that
// rotates from tilted to flat + scales as you scroll). Ported verbatim, with a
// useReducedMotion guard added.
...
const Card = ({
  ...
  <motion.div
    style={{
      rotateX: rotate,
      scale,
      border: "4px solid #2a2731",
      background: "#101015",
      boxShadow: "0 0 #0000004d, 0 9px 20px #0000004a, 0 37px 37px #00000042, 0 84px 50px #00000026, 0 149px 60px #0000000a, 0 233px 65px #00000003",
    }}
    className="mx-auto -mt-12 h-[28rem] w-full max-w-5xl rounded-[30px] p-2 shadow-2xl md:h-[40rem] md:p-4"
  >
    <div className="h-full w-full overflow-hidden rounded-2xl" style={{ background: "#0d0c0f" }}>
      {children}
    </div>
  </motion.div>
);
